...
public class OrderGoods extends BasePojo{
	...
	public String toString() {
		return "OrderGoodsPage [orderId=" + orderId + ", adresName=" + adresName
				+ ", adresMobile=" + adresMobile + ", adresAddr=" + adresAddr
				+ ", message=" + message + ", orderGoodsStatus="
				+ orderGoodsStatus + ", courierCompany=" + courierCompany
				+ ", courierNumber=" + courierNumber + ", remark=" + remark
				+ "]";
	}

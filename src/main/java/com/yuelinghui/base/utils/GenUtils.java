...
import com.yuelinghui.entity.ColumnEntity;
import com.yuelinghui.entity.TableEntity;
...
//        templates.add("template/Dao.xml.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtil.formatDateToYYYYMDHMS(new Date()));
        ...
        for(String template : templates){
            ...
            try {
                ...
                logger.error("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
    }
...
//        }
        ...
        if(template.contains("index.html.vm")){
            return "main" + File.separator + "webapp" + File.separator + "WEB-INF" + File.separator + "page"
                    + File.separator + className.toLowerCase() + File.separator + "index"+ ".html";
        }

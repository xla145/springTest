...
public class DateUtil {
    ...
    public static Date stringToDate(String dateStr, String formatStr) {
        if (StringUtils.isBlank(formatStr)) {
            formatStr = stringToDateFormatHH;
        }
...
//        byte[] date = "***".getBytes("GBK");
//        System.out.println(new char[]{'中'}[0]);
//        System.out.println("https://img.yuelinghui.com/yue-product/file/GIT常用经验GIT常用经验GIT常用经验.pdf".length());
